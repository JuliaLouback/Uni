...
namespace Uni.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        {
            [Required]
            [StringLength(7, ErrorMessage = "O {0} deve estar entre {2} e {1} caractéres.", MinimumLength = 6)]
